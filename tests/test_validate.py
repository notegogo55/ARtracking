...
def test_crossval_climatology_has_no_skill():
    ...
    per_fold, oof = crossval_table(
        X, y, _times(n), ["a", "b"], horizon_steps=4, n_folds=3,
        embargo_hours=0, model_names=("climatology",),
    )
...
def test_aggregate_table_orders_by_tss():
    per_fold = pd.DataFrame([
        {"model": "a", "fold": 0, "tss": 0.2, "hss": 0.1, "bss": 0.0,
         "brier": 0.2, "precision": 0.5, "recall": 0.5},
        {"model": "a", "fold": 1, "tss": 0.4, "hss": 0.2, "bss": 0.1,
         "brier": 0.2, "precision": 0.5, "recall": 0.5},
        {"model": "b", "fold": 0, "tss": 0.8, "hss": 0.6, "bss": 0.3,
         "brier": 0.1, "precision": 0.7, "recall": 0.7},
        {"model": "b", "fold": 1, "tss": 0.6, "hss": 0.5, "bss": 0.2,
         "brier": 0.1, "precision": 0.7, "recall": 0.7},
    ])
